...
function setup(){
	...
	engine = Engine.create();
      ...
      stoneObj= new Stone(100,670,60,60);

    launcherObj= new Launcher (stoneObj.body,{x:100,y:670})
}
...
function mouseDragged(){
      Matter.Body.setPosition(stoneObj.body, {x:85 , y: -85});
  }
